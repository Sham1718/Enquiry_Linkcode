...
export function buildMockNotifications(): NotificationsResponse {
  const items: NotificationItem[] = [
    ...
    },
    {
      ...
      message: `${MOCK_ENQUIRIES[2].studentName} is now INTERESTED.`,
      isRead: false,
      type: "STATUS_CHANGED",
    ...
    },
    {
      ...
      message: `Follow up for ${MOCK_ENQUIRIES[3].studentName}.`,
      isRead: true,
      type: "FOLLOW_UP",
    ...
    },
    {
      ...
      message: `${MOCK_ENQUIRIES[4].studentName} is now HOT.`,
      isRead: true,
      type: "STATUS_CHANGED",
